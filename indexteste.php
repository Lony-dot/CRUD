...
<html lang="pt-br">
	...
	<body>
	            ...
	            <li class="<?= $erro == 1 ? 'open' : '' ?>">
					...
					<ul class="dropdown-menu" aria-labelledby="entrar">
						<div class="col-md-12">
				    		...
				    		<br />
							<form method="post" action="salvar-usuario.php" id="formLogin">
	    ...
	    <div class="container">
	      ...
	      <div class="jumbotron">
	        <h1>Bem vindo ao Pegasus</h1>
            <p>Realize o Login e cadastre seu pedido...</p>
	      </div>
